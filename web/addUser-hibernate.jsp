...
<center>
    <h1>Управление</h1>
    <h2>
        <a href="/admin/allUser-hibernate">Список всех пользователей</a><br><br>
...
<div align="center">
    <c:if test="${user != null}">
    <form action="/admin/edit-hibernate" method="post">
        </c:if>
        <c:if test="${user == null}">
        <form action="/admin/new-hibernate" method="post">
            </c:if>
